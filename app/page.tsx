...
export default function Home() {
  ...
  return (
    <main className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12">
      ...
      <a
        href="/api/oauth"
        className="text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 mb-6"
      >
        <svg
